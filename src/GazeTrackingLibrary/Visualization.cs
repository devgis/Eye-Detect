            ...
            switch (Settings.Instance.Visualization.VideoMode)
            {
                case VideoModeEnum.Normal:
                    if(Operations.IsWithinBounds(rectangle, gray.ROI))
                    {
                        ...
                        Debug.WriteLine($"Normal {rectangle.X},{rectangle.Y},{rectangle.Width},{rectangle.Height}");
                        Message = $"Normal {rectangle.X},{rectangle.Y},{rectangle.Width},{rectangle.Height}"; //liyafei
                    }
                ...
                case VideoModeEnum.Processed:
                    if (Operations.IsWithinBounds(rectangle, processed.ROI)) {
                        ...
                        Debug.WriteLine($"Processed {rectangle.X},{rectangle.Y},{rectangle.Width},{rectangle.Height}");
                        Message = $"Processed {rectangle.X},{rectangle.Y},{rectangle.Width},{rectangle.Height}";//liyafei
                    }
                    break;
            }
        }
