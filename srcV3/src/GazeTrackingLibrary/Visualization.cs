...
namespace GazeTrackingLibrary
{
    public class Visualization
    {
        ...
        {
            StaticData.IsBlackCrossEnabled = false; //liyafei add reset
            StaticData.IsWhiteCrossEnabled = false; //liyafei add reset
            if (gray == null)
                return;
            ...
            if (Settings.Instance.Visualization.VideoMode == VideoModeEnum.Processed)
            {
                ...
                {
                    StaticData.IsBlackCrossEnabled = true;
                    // Left
            ...
            if (Settings.Instance.Visualization.DrawPupil)
            {
                if (trackData.PupilDataLeft.Center.X != 0)
                {
                    ...
                    StaticData.IsBlackCrossEnabled = true; //liyafei add set the Pupil found flag is enabled
                    StaticData.BlackCrossPosition = new MyPosition(
                        trackData.PupilDataLeft.Center.X, 
                        trackData.PupilDataLeft.Center.Y);//liyafei add update the  BlackCrossPosition
                }
                ...
                if (trackData.PupilDataRight.Center.X != 0)
                {
                    ...
                    StaticData.IsBlackCrossEnabled = true; //liyafei add set the Pupil found flag is enabled
                    StaticData.BlackCrossPosition = new MyPosition(
                        trackData.PupilDataRight.Center.X, 
                        trackData.PupilDataRight.Center.Y); //liyafei add update the  BlackCrossPosition
                }
            ...
            if (Settings.Instance.Processing.TrackingGlints)
            {
                ...
                {
                    StaticData.IsWhiteCrossEnabled = true; //liyafei add set the Glint found flag is enabled
                    DrawGlints(trackData.GlintDataLeft.Glints, Settings.Instance.Processing.GlintSizeMaximum / 2);
                    StaticData.WhiteCrossPosition = new MyPosition(
                        trackData.GlintDataLeft.Glints.AverageCenter.X, 
                        trackData.GlintDataLeft.Glints.AverageCenter.Y); //liyafei add update the  WhiteCrossPosition
                }
                    ...
                    trackData.GlintDataRight.Glints.Centers[0].X != 0)
                {
                    ...
                    StaticData.WhiteCrossPosition = new MyPosition(
                        ...
                        trackData.GlintDataRight.Glints.AverageCenter.Y);//liyafei add update the  WhiteCrossPosition
                }
            }
